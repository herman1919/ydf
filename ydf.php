...
ulang:
// function change(){
echo color("red","            gunakan no yg belum terdaftar \n");
echo color("green","                selamat menikmati😁 \n");
...
echo color("red","                  Format Kode 62*** \n");
	...
	$post = [
         ...
         echo color("white","▬▬▬▬▬▬▬▬▬▬▬▬▬▬ PIN MU = 232323 ▬▬▬▬▬▬▬▬▬▬▬▬")."\n";
         $data2 = '{"pin":"232323"}';
